                  ...
                  if (isset($_SESSION["timeout"]) && !empty($_SESSION["timeout"])) {
                      ...
                      if ($stmt = $db->prepare($query)) {
                          ...
                          if($stmt->num_rows > 0) {
                              ...
                              // does not have this username in account table, but will pretend we have
                              $_SESSION["username"] = $username;
                          }
                          // after checking the account table, check if that username has record in the loginAttempts table
