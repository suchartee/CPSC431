      ...
      echo "<div class=\"header\" style=\"display:table;\">All Matches</div>
          ...
          while( $stmt->fetch() ) {
                ...
                echo "<tr>
                  ...
                  <td>". $row['winteam'] ."</td>
                  <td>". $row['lostteam'] ."</td>
                  <td><a href=\"changematchinfo.php?hometeam=".$row['hometeam']."&awayteam=".$row['awayteam']."&homescore=".$row['homescore']."&awayscore=".$row['awayscore']."&dateplayed=".$row['dateplayed']."&winteam=".$row['winteam']."&lostteam=".$row['lostteam']."\">Change</a>
